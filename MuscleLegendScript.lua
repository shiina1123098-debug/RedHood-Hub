...
LogoImg.Image = "rbxassetid://103250084334293"
...
local function startTracker()
    ...
    _trackerConn = RunService.Heartbeat:Connect(function()
                    ...
                    for _, obj in pairs(workspace.machinesFolder:GetDescendants()) do
                        if obj.Name == "neededDurability" and obj.Value == reqDura
                            ...
                            if rock then
                                ...
                                gettool()
                                _rockHits = _rockHits + 1  -- contar golpe
                            end
                        end
                    end
                end
...
BubbleLabel.Image = "rbxassetid://103250084334293"
...
LogoText.Image = "rbxassetid://103250084334293"
