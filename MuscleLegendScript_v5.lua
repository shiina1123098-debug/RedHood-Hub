...
local CloseBtn = MakeHeaderBtn(-34, "✕", Color3.fromRGB(190, 30, 50))
...
local flyS  = makeFlyBtn("S",  62, 55)  -- atrás
...
CreateButton(tpPanel, "TP + Plataforma Segura", function()
    ...
    -- Líneas de grilla neon (sutiles) — cruce en X
    ...
    -- 4 líneas longitudinales + 4 transversales
    for i = -30, 30, 20 do
...
local loadMsgs = {"Inicializando...", "Cargando módulos...", "Conectando eventos...", "Preparando UI...", "Casi listo..."}
task.spawn(function()
    local t = 0
    local msgIdx = 1
    local msgTimer = 0
