...
-- Logo â€” borde con pulso animado
...
SubTitle.Text = "v4  Â·  Muscle Legends"
...
local MinBtn   = MakeHeaderBtn(-68, "â€”", Color3.fromRGB(200, 160, 20))
local CloseBtn = MakeHeaderBtn(-34, "âœ•", Color3.fromRGB(190, 30, 50))
...
StatusLabel.Text = "RedHood Hub v4  Â·  Muscle Legends"
...
local function activateFly(char)
    ...
    -- Mostrar botones solo en mÃ³vil
...
CreateButton(tpPanel, "TP + Plataforma Segura", function()
    ...
    -- Plataforma principal â€” negro oscuro
    ...
    -- Borde neon rojo â€” 4 tiras en los bordes
    ...
    -- LÃ­neas de grilla neon (sutiles) â€” cruce en X
...
LoadBy.Text = "by Shiina  Â·  Muscle Legends"
...
local loadMsgs = {"Inicializando...", "Cargando mÃ³dulos...", "Conectando eventos...", "Preparando UI...", "Casi listo..."}
task.spawn(function()
    local t = 0
    local msgIdx = 1
    local msgTimer = 0
